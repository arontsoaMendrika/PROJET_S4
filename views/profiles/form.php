    ...
    <header class="header">
        <nav class="nav container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="?user_id=<?php echo $userId; ?>" class="text-yellow-400">Profils</a></li>
            </ul>
        </nav>
    </header>
    ...
    <main class="container py-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="../index.php?controller=profile&action=save" class="space-y-8">
                        ...
                        <div class="mt-6 p-4 bg-dark bg-opacity-50 rounded-lg">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <span id="bmiCategory" class="ml-3 text-white"></span>
                                </div>
                    ...
                    <div class="flex justify-end space-x-4">
                        <?php if (isset($profile)): ?>
                            <a href="show.php?user_id=<?php echo $userId; ?>" class="btn btn-secondary">
                                Annuler
                            </a>
                        <?php else: ?>
                            <a href="../home.php" class="btn btn-secondary">
    ...
    <script>
        function calculateBMI() {
            ...
            if (height && weight) {
                ...
                categoryElement.className = 'ml-3 ' + colorClass;
            } else {
        ...
        // Calculer l'IMC au chargement si les valeurs sont présentes
