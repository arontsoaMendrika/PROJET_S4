...
<div class="container mb-5">
    <div class="d-flex justify-content-between align-items-center mb-5">
        <h3 style="font-family:'Montserrat', sans-serif; font-weight:600; color:var(--el-dark-grey);">Base Nutritive</h3>
    ...
    <?php if (isset($_SESSION['success'])): ?>
        <div class="alert alert-success mt-4 rounded-0" style="border-color:var(--el-gold); color:var(--el-gold-dark); background:#fdfcf9;">
    ...
    <div class="card p-4 mb-5">
        <form id="searchForm" class="row g-3">
            <div class="col-md-4">
                <input type="text" name="query" class="form-control rounded-0" placeholder="Rechercher par mot-clé..." value="<?= htmlspecialchars($_GET['search'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
            </div>
            <div class="col-md-4">
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-4">
            <div class="stat-card border-dark">
                <h3 style="color:var(--el-gold-dark);"><?= count(array_filter($regimes, fn($r) => $r['base_price'] <= 35)); ?></h3>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="small">
                            <span style="color:#C5A059; font-weight:bold;">P:</span> <?= $regime['protein_percentage'] ?>%<br>
                            <span style="color:#C5A059; font-weight:bold;">G:</span> <?= $regime['carbs_percentage'] ?>%<br>
                            <span style="color:#C5A059; font-weight:bold;">L:</span> <?= $regime['fat_percentage'] ?>%
                        </div>
                    </td>
                    <td class="text-center">
                        <span class="badge" style="background-color:var(--el-dark-grey); color:var(--el-gold); padding:8px 12px; font-weight:normal; letter-spacing:1px; border-radius:0;">
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            <a href="<?= base_url('regimes/show/'.$regime['id']) ?>" class="btn btn-sm btn-outline-elegant" title="Détails"><i class="fas fa-eye"></i></a>
                            <a href="<?= base_url('regimes/edit/'.$regime['id']) ?>" class="btn btn-sm btn-outline-elegant border-start-0" title="Modifier"><i class="fas fa-edit"></i></a>
                            <a href="<?= base_url('regimes/delete/'.$regime['id']) ?>" class="btn btn-sm btn-dark" title="Supprimer" onclick="return confirm('Confirmer la suppression de cette gamme ?');"><i class="fas fa-trash"></i></a>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
